...
namespace: example
components:
  - https://github.com/marinatedconcrete/config/kustomization/components/k3s-kubernetes-api-egress?ref=kustomize-k3s-kubernetes-api-egress@v{version}
```
...
```yaml
resources:
  - https://github.com/marinatedconcrete/config/releases/download/kustomize-k3s-kubernetes-api-egress@v{version}/kustomize-k3s-kubernetes-api-egress.yml
```
