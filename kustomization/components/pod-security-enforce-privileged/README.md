...
components:
  - https://github.com/marinatedconcrete/config/kustomization/components/pod-security-enforce-privileged?ref=kustomize-pod-security-enforce-privileged@v{version}
```
